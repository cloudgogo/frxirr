...
WL_HOME="/home/weblogic1/Oracle/Middleware/wlserver_10.3"
export WL_HOME

BEA_JAVA_HOME=""
export BEA_JAVA_HOME

SUN_JAVA_HOME="/home/weblogic1/jdk1.6.0_45"
...
if [ "${JAVA_VENDOR}" = "Oracle" ] ; then
	...
	if [ "${JAVA_VENDOR}" = "Sun" ] ; then
		...
		JAVA_VENDOR="Sun"
		export JAVA_VENDOR
		JAVA_HOME="/home/weblogic1/jdk1.6.0_45"
		export JAVA_HOME
	fi
fi
...
DOMAIN_HOME="/home/weblogic1/Oracle/Middleware/user_projects/domains/base_domain"
export DOMAIN_HOME

LONG_DOMAIN_HOME="/home/weblogic1/Oracle/Middleware/user_projects/domains/base_domain"
...
if [ "${JAVA_VENDOR}" = "Sun" ] ; then
	WLS_MEM_ARGS_64BIT="-Xmx2048m -Xmx2048m"
	export WLS_MEM_ARGS_64BIT
	WLS_MEM_ARGS_32BIT="-Xmx2048m -Xmx2048m"
...
JAVA_VM="${JAVA_VM} -Xms2048m -Xmx2048m -XX:CompileThreshold=8000 -XX:PermSize=512m -XX:MaxPermSize=1024m"
